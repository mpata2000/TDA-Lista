...
bool mostrar_elemento_mendez(void* elemento, void* contador){
    if(elemento && contador)
        printf("Elemento %i: %c \n", (*(int*)contador)++, *(char*)elemento);
    return true;
}

void probar_operaciones_lista_mendez(){
    ...
    elementos_recorridos = lista_con_cada_elemento(lista, mostrar_elemento_mendez, (void*)&contador);
...
void probar_operaciones_cola_mendez(){
...
void probar_operaciones_pila_mendez(){
...
void pruebas_catedra(){
    ...
    probar_operaciones_lista_mendez();
  
    printf("\nPruebo el comportamiento de cola\n");
    probar_operaciones_cola_mendez();
    
    printf("\nPruebo el comportamiento de pila\n");
    probar_operaciones_pila_mendez();
